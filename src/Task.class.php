...
class Task
{
  ...
  protected static string $currentPID = '_parent_';
    
  private static bool $envPassed = false;
    
  private static function _checkRequirements(): void
  {
  ...
  public static function currentPID(): string
  {
  ...
  public function start(array $args = []): void
  {
    ...
    if ($pid) {
      ...
      register_shutdown_function(function () {
        ...
        if (apcu_exists($key)) {
          apcu_delete($key);
        } // remove any store data destined for the child.
        detach_kill();
      });
